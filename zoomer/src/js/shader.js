...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
	...
	/*fragColor.r = (0.3 * fragColor.r + 0.59*fragColor.g + 0.11*fragColor.b);
...
shaderToyFragCode = shaderToyFragCode.replace( /mainImage(.*)/gi, 'main()');
shaderToyFragCode = shaderToyFragCode.replace( /fragColor/gi, 'gl_FragColor');
shaderToyFragCode = shaderToyFragCode.replace( /fragCoord/gi, 'gl_FragCoord');
shaderToyFragCode = shaderToyFragCode.replace( /iTime/gi, 'u_time');
shaderToyFragCode = shaderToyFragCode.replace( /iMouse/gi, 'u_mouse');
shaderToyFragCode = shaderToyFragCode.replace( /iResolution/gi, 'u_resolution');

console.log( shaderToyFragCode)

sandbox.load(shaderToyFragCode);