...
mxGraph.prototype.allowNegativeCoordinates=true;  // al, change this to false when normalising numbers with underlying zoom
...
if (typeof mxVertexHandler != 'undefined')
{
	(function()
	{
		...
		{
			console.log('mxVertexHandler',mxUtils.getValue(state.style, 'recursiveResize', 'default') );
