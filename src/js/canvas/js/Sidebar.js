...
Sidebar.prototype.init = function()
{
	...
	this.addStencilPalette('arrows', mxResources.get('arrows'), dir + '/arrows.xml',
		';whiteSpace=wrap;html=0;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
 ...
 */
Sidebar.prototype.tooltipDelay = 50;
...
Sidebar.prototype.addGraphExecutionPalette = function( expand){
    var fns = [
        this.createVertexTemplateEntry('triangle;whiteSpace=wrap;html=0;', 60, 80, '', 'Triangle', null, null, 'Play graph or selected nodes'),

        //this.createVertexTemplateEntry('swimlane;whiteSpace=wrap;html=0;', 200, 200, 'Container', 'Container', null, null, 'container swimlane lane pool'),
    ];
...
/** Adds blueprint palette to the sidebar */

Sidebar.prototype.addBlueprintPalette = function( expand){
    var javascriptPlay = "play=function( params){ eval( params.node.getValue());}";
    var nodeJSPlay = "play=function( params){ alert( params.node.getValue());}";
    var fns = [
        this.createVertexTemplateEntry('swimlane;whiteSpace=wrap;html=0;', 200, 200, 'Container', 'Container', null, null, 'container swimlane lane pool'),
        this.createEdgeTemplateEntry('endArrow=classic;html=0;', 50, 50, '', 'Connection'),
       // this.createEdgeTemplateEntry('endArrow=classic;startArrow=classic;html=0;', 50, 50, '', 'Connection')

        this.createVertexTemplateEntry('shape=javascript;whiteSpace=wrap;html=0;'+javascriptPlay, 120, 60, 'JS', 'JavaScript', null, null, 'Plain old javascript runner'),
        this.createVertexTemplateEntry('shape=nodejs;whiteSpace=wrap;html=0;'+nodeJSPlay, 120, 60, 'NodeJS', 'NodeJS', null, null, 'Run in NodeJS')
	];

	this.addPaletteFunctions( 'Blueprint', mxResources.get('blueprint'),  (expand != null) ? expand : true, fns);
}
...
Sidebar.prototype.addGeneralPalette = function(expand)
{
    var sb = this;
    // Reusable cells
    var field = new mxCell('List Item', new mxGeometry(0, 0, 60, 26), 'text;html=0;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;whiteSpace=wrap;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
    field.vertex = true;

    var field = new mxCell('+ field: type', new mxGeometry(0, 0, 100, 26), 'text;html=0;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;whiteSpace=wrap;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
    field.vertex = true;

    var divider = new mxCell('', new mxGeometry(0, 0, 40, 8), 'line;html=0;strokeWidth=1;fillColor=none;align=left;verticalAlign=middle;spacingTop=-1;spacingLeft=3;spacingRight=3;rotatable=0;labelPosition=right;points=[];portConstraint=eastwest;');
    divider.vertex = true;
	...
	var fns = [
        this.createVertexTemplateEntry('swimlane;whiteSpace=wrap;html=0;', 200, 200, 'Container', 'Container', null, null, 'container swimlane lane pool'),
	 	this.createVertexTemplateEntry('whiteSpace=wrap;html=0;', 120, 60, '', 'Rectangle', null, null, 'rect rectangle box'),
	 	this.createVertexTemplateEntry('rounded=1;whiteSpace=wrap;html=0;', 120, 60, '', 'Rounded Rectangle', null, null, 'rounded rect rectangle box'),
 		this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=0;', 120, 80, '', 'Ellipse', null, null, 'oval ellipse state'),
	 	// Explicit strokecolor/fillcolor=none is a workaround to maintain transparent background regardless of current style
 		this.createVertexTemplateEntry('text;html=0;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;',
 			40, 20, 'Text', 'Text', null, null, 'text textbox textarea label'),
 		this.createVertexTemplateEntry('shape=ext;double=1;whiteSpace=wrap;html=0;', 120, 60, '', 'Double Rectangle', null, null, 'rect rectangle box double'),
	 	this.createVertexTemplateEntry('shape=ext;double=1;rounded=1;whiteSpace=wrap;html=0;', 120, 60, '', 'Double Rounded Rectangle', null, null, 'rounded rect rectangle box double'),
	 	this.createVertexTemplateEntry('ellipse;shape=doubleEllipse;whiteSpace=wrap;html=0;', 120, 80, '', 'Double Ellipse', null, null, 'oval ellipse start end state double'),
	 	this.createVertexTemplateEntry('rhombus;whiteSpace=wrap;html=0;', 80, 80, '', 'Diamond', null, null, 'diamond rhombus if condition decision conditional question test'),
	 	this.createVertexTemplateEntry('shape=parallelogram;whiteSpace=wrap;html=0;', 120, 60, '', 'Parallelogram'),
	 	this.createVertexTemplateEntry('triangle;whiteSpace=wrap;html=0;', 60, 80, '', 'Triangle', null, null, 'triangle logic inverter buffer'),
	 	this.createVertexTemplateEntry('shape=cylinder;whiteSpace=wrap;html=0;', 60, 80, '', 'Cylinder', null, null, 'cylinder data database'),
	 	this.createVertexTemplateEntry('shape=hexagon;perimeter=hexagonPerimeter;whiteSpace=wrap;html=0;', 120, 80, '', 'Hexagon', null, null, 'hexagon preparation'),
	 	this.createVertexTemplateEntry('shape=process;whiteSpace=wrap;html=0;', 120, 60, '', 'Process', null, null, 'process task'),
	 	this.createVertexTemplateEntry('ellipse;shape=cloud;whiteSpace=wrap;html=0;', 120, 80, '', 'Cloud', null, null, 'cloud network'),
	 	this.createVertexTemplateEntry('shape=document;whiteSpace=wrap;html=0;', 120, 80, '', 'Document'),
	 	this.createVertexTemplateEntry('shape=internalStorage;whiteSpace=wrap;html=0;', 80, 80, '', 'Internal Storage'),
	 	this.createVertexTemplateEntry('shape=cube;whiteSpace=wrap;html=0;', 120, 80, '', 'Cube'),
	 	this.createVertexTemplateEntry('shape=step;whiteSpace=wrap;html=0;', 120, 80, '', 'Step'),
	 	this.createVertexTemplateEntry('shape=trapezoid;whiteSpace=wrap;html=0;', 120, 60, '', 'Trapezoid'),
	 	this.createVertexTemplateEntry('shape=tape;whiteSpace=wrap;html=0;', 120, 100, '', 'Tape'),
	 	this.createVertexTemplateEntry('shape=note;whiteSpace=wrap;html=0;', 80, 100, '', 'Note'),
	    this.createVertexTemplateEntry('shape=card;whiteSpace=wrap;html=0;', 80, 100, '', 'Card'),
        this.createVertexTemplateEntry('whiteSpace=wrap;html=0;aspect=fixed;', 80, 80, '', 'Square', null, null, 'square'),
        this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=0;aspect=fixed;', 80, 80, '', 'Circle', null, null, 'circle'),
        this.createVertexTemplateEntry('shape=ext;double=1;whiteSpace=wrap;html=0;aspect=fixed;', 80, 80, '', 'Double Square', null, null, 'double square'),
        this.createVertexTemplateEntry('ellipse;shape=doubleEllipse;whiteSpace=wrap;html=0;aspect=fixed;', 80, 80, '', 'Double Circle', null, null, 'double circle'),
        this.createVertexTemplateEntry('text;html=0;fontSize=24;fontStyle=1;verticalAlign=middle;align=center;', 100, 40, 'Title', 'Title', null, null, 'text heading title'),
        this.createVertexTemplateEntry('text;html=0;spacing=5;spacingTop=-20;whiteSpace=wrap;overflow=hidden;', 190, 120,
        ...
        this.createVertexTemplateEntry('text;html=0;whiteSpace=wrap;verticalAlign=middle;overflow=hidden;', 100, 80,
        ...
        this.createVertexTemplateEntry('text;html=0;fillColor=#ffffff;overflow=fill;rounded=0;', 280, 160,
        ...
        this.createVertexTemplateEntry('text;html=0;strokeColor=#c0c0c0;overflow=fill;', 180, 140,
        ...
        this.createVertexTemplateEntry('text;html=0;overflow=fill;', 180, 140,
        ...
        this.createVertexTemplateEntry('text;html=0;overflow=fill;', 160, 140,
            '<table border="1" width="100%" height="100%" cellpadding="4" style="width:100%;height:100%;border-collapse:collapse;">' +
        ...
        {
            var cell = new mxCell('Link', new mxGeometry(0, 0, 60, 40), 'text;html=0;whiteSpace=wrap;align=center;verticalAlign=middle;fontColor=#0000EE;fontStyle=4;');
            cell.vertex = true;
        ...
        {
            var cell = new mxCell('%date{ddd mmm dd yyyy HH:MM:ss}%', new mxGeometry(0, 0, 160, 20), 'text;html=0;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;overflow=hidden;');
            cell.vertex = true;
        ...
        {
            var cell = new mxCell('%name% Text', new mxGeometry(0, 0, 80, 20), 'text;html=0;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;overflow=hidden;');
            cell.vertex = true;
            this.graph.setAttributeForCell(cell, 'placeholders', '1');
        ...
        this.createVertexTemplateEntry('shape=umlActor;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;html=0;', 30, 60, 'Actor', 'Actor', false, null, 'user person human stickman'),
        this.createVertexTemplateEntry('html=0;whiteSpace=wrap;comic=1;strokeWidth=2;fontFamily=Comic Sans MS;fontStyle=1;', 120, 60, 'RECTANGLE', 'Comic Rectangle', true, null, 'comic rectangle rect box text retro'),
        this.createVertexTemplateEntry('rhombus;html=0;align=center;whiteSpace=wrap;comic=1;strokeWidth=2;fontFamily=Comic Sans MS;fontStyle=1;', 100, 100, 'DIAMOND', 'Comic Diamond', true, null, 'comic diamond rhombus if condition decision conditional question test retro'),
        this.createEdgeTemplateEntry('edgeStyle=segmentEdgeStyle;rounded=0;comic=1;strokeWidth=2;endArrow=blockThin;html=0;fontFamily=Comic Sans MS;fontStyle=1;', 50, 50, '', 'Comic Arrow 1'),
        this.createEdgeTemplateEntry('rounded=0;comic=1;strokeWidth=2;endArrow=blockThin;html=0;fontFamily=Comic Sans MS;fontStyle=1;', 50, 50, '', 'Comic Arrow 2'),
        this.createVertexTemplateEntry('html=0;whiteSpace=wrap;aspect=fixed;shape=isoRectangle;', 150, 90, '', 'Isometric Square', true, null, 'rectangle rect box iso isometric'),
        this.createVertexTemplateEntry('html=0;whiteSpace=wrap;aspect=fixed;shape=isoCube;', 90, 100, '', 'Isometric Cube', true, null, 'cube box iso isometric'),
        this.createEdgeTemplateEntry('edgeStyle=isometricEdgeStyle;endArrow=none;html=0;', 50, 100, '', 'Isometric Edge 1'),
        this.createEdgeTemplateEntry('edgeStyle=isometricEdgeStyle;endArrow=none;html=0;elbow=vertical;', 50, 100, '', 'Isometric Edge 2'),
        this.createVertexTemplateEntry('line;strokeWidth=2;html=0;', 160, 10, '', 'Horizontal Line'),
        this.createVertexTemplateEntry('line;strokeWidth=2;direction=south;html=0;', 10, 160, '', 'Vertical Line'),
        this.createVertexTemplateEntry('line;strokeWidth=4;html=0;perimeter=backbonePerimeter;points=[];outlineConnect=0;', 160, 10, '', 'Horizontal Backbone', false, null, 'backbone bus network'),
        this.createVertexTemplateEntry('line;strokeWidth=4;direction=south;html=0;perimeter=backbonePerimeter;points=[];outlineConnect=0;', 10, 160, '', 'Vertical Backbone', false, null, 'backbone bus network'),
        this.createVertexTemplateEntry('shape=curlyBracket;whiteSpace=wrap;html=0;rounded=1;', 20, 120, '', 'Curly Bracket'),
        this.createVertexTemplateEntry('shape=image;html=0;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;imageAspect=1;aspect=fixed;image=' + this.gearImage, 52, 61, '', 'Image (Fixed Aspect)', false, null, 'fixed image icon symbol'),
        this.createVertexTemplateEntry('shape=image;html=0;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;imageAspect=0;image=' + this.gearImage, 50, 60, '', 'Image (Variable Aspect)', false, null, 'strechted image icon symbol'),
        this.createVertexTemplateEntry('icon;html=0;image=' + this.gearImage, 60, 60, 'Icon', 'Icon', false, null, 'icon image symbol'),
        this.createVertexTemplateEntry('label;whiteSpace=wrap;html=0;image=' + this.gearImage, 140, 60, 'Label', 'Label 1', null, null, 'label image icon symbol'),
        this.createVertexTemplateEntry('label;whiteSpace=wrap;html=0;align=center;verticalAlign=bottom;spacingLeft=0;spacingBottom=4;imageAlign=center;imageVerticalAlign=top;image=' + this.gearImage, 120, 80, 'Label', 'Label 2', null, null, 'label image icon symbol'),
        this.createEdgeTemplateEntry('shape=flexArrow;endArrow=classic;html=0;fillColor=#ffffff;', 50, 50, '', 'Arrow'),
        this.createEdgeTemplateEntry('shape=flexArrow;endArrow=classic;startArrow=classic;html=0;fillColor=#ffffff;', 50, 50, '', 'Arrow'),
        this.createEdgeTemplateEntry('endArrow=none;html=0;dashed=1;dashPattern=1 4;', 50, 50, '', 'Dotted Line'),
        this.createEdgeTemplateEntry('endArrow=none;dashed=1;html=0;', 50, 50, '', 'Dashed Line'),
        this.createEdgeTemplateEntry('endArrow=none;html=0;', 50, 50, '', 'Line'),
        this.createEdgeTemplateEntry('edgeStyle=segmentEdgeStyle;endArrow=classic;html=0;', 50, 50, '', 'Manual Line'),
        this.createEdgeTemplateEntry('edgeStyle=elbowEdgeStyle;elbow=horizontal;endArrow=classic;html=0;', 50, 50, '', 'Horizontal Elbow'),
        this.createEdgeTemplateEntry('edgeStyle=elbowEdgeStyle;elbow=vertical;endArrow=classic;html=0;', 50, 50, '', 'Vertical Elbow'),
        ...
        this.createEdgeTemplateEntry('shape=link;html=0;', 50, 50, '', 'Link'),
        this.createVertexTemplateEntry('shape=xor;whiteSpace=wrap;html=0;', 60, 80, '', 'Or', null, null, 'logic or'),
        this.createVertexTemplateEntry('shape=or;whiteSpace=wrap;html=0;', 60, 80, '', 'And', null, null, 'logic and'),
        this.createVertexTemplateEntry('shape=dataStorage;whiteSpace=wrap;html=0;', 100, 80, '', 'Data Storage'),
        this.createVertexTemplateEntry('shape=tapeData;whiteSpace=wrap;html=0;perimeter=ellipsePerimeter;', 80, 80, '', 'Tape Data'),
        this.createVertexTemplateEntry('shape=manualInput;whiteSpace=wrap;html=0;', 80, 80, '', 'Manual Input'),
        this.createVertexTemplateEntry('shape=loopLimit;whiteSpace=wrap;html=0;', 100, 80, '', 'Loop Limit'),
        this.createVertexTemplateEntry('shape=offPageConnector;whiteSpace=wrap;html=0;', 80, 80, '', 'Off Page Connector'),
        this.createVertexTemplateEntry('shape=delay;whiteSpace=wrap;html=0;', 80, 40, '', 'Delay'),
        this.createVertexTemplateEntry('shape=display;whiteSpace=wrap;html=0;', 80, 40, '', 'Display'),
        this.createVertexTemplateEntry('shape=singleArrow;direction=west;whiteSpace=wrap;html=0;', 100, 60, '', 'Arrow Left'),
        this.createVertexTemplateEntry('shape=singleArrow;whiteSpace=wrap;html=0;', 100, 60, '', 'Arrow Right'),
        this.createVertexTemplateEntry('shape=singleArrow;direction=north;whiteSpace=wrap;html=0;', 60, 100, '', 'Arrow Up'),
        this.createVertexTemplateEntry('shape=singleArrow;direction=south;whiteSpace=wrap;html=0;', 60, 100, '', 'Arrow Down'),
        this.createVertexTemplateEntry('shape=doubleArrow;whiteSpace=wrap;html=0;', 100, 60, '', 'Double Arrow'),
        this.createVertexTemplateEntry('shape=doubleArrow;direction=south;whiteSpace=wrap;html=0;', 60, 100, '', 'Double Arrow Vertical', null, null, 'double arrow'),
        this.createVertexTemplateEntry('shape=actor;whiteSpace=wrap;html=0;', 40, 60, '', 'User', null, null, 'user person human'),
        this.createVertexTemplateEntry('shape=cross;whiteSpace=wrap;html=0;', 80, 80, '', 'Cross'),
        this.createVertexTemplateEntry('shape=corner;whiteSpace=wrap;html=0;', 80, 80, '', 'Corner'),
        this.createVertexTemplateEntry('shape=tee;whiteSpace=wrap;html=0;', 80, 80, '', 'Tee'),
        this.createVertexTemplateEntry('shape=datastore;whiteSpace=wrap;html=0;', 60, 60, '', 'Data Store', null, null, 'data store cylinder database'),
        this.createVertexTemplateEntry('shape=orEllipse;perimeter=ellipsePerimeter;whiteSpace=wrap;html=0;', 80, 80, '', 'Or', null, null, 'or circle oval ellipse'),
        this.createVertexTemplateEntry('shape=sumEllipse;perimeter=ellipsePerimeter;whiteSpace=wrap;html=0;', 80, 80, '', 'Sum', null, null, 'sum circle oval ellipse'),
        this.createVertexTemplateEntry('shape=lineEllipse;perimeter=ellipsePerimeter;whiteSpace=wrap;html=0;', 80, 80, '', 'Ellipse with horizontal divider', null, null, 'circle oval ellipse'),
        this.createVertexTemplateEntry('shape=lineEllipse;line=vertical;perimeter=ellipsePerimeter;whiteSpace=wrap;html=0;', 80, 80, '', 'Ellipse with vertical divider', null, null, 'circle oval ellipse'),
        this.createVertexTemplateEntry('shape=sortShape;perimeter=rhombusPerimeter;whiteSpace=wrap;html=0;', 80, 80, '', 'Sort', null, null, 'sort'),
        this.createVertexTemplateEntry('shape=collate;whiteSpace=wrap;html=0;', 80, 80, '', 'Collate', null, null, 'collate'),
        this.createVertexTemplateEntry('shape=switch;whiteSpace=wrap;html=0;', 60, 60, '', 'Switch', null, null, 'switch router'),
        this.createVertexTemplateEntry('shape=dimension;whiteSpace=wrap;html=0;align=center;points=[];verticalAlign=bottom;spacingBottom=-5;labelBackgroundColor=#ffffff', 100, 40, 'Label', 'Horizontal Dimension', null, null, 'horizontal dimension measure'),
        this.createVertexTemplateEntry('shape=dimension;direction=north;whiteSpace=wrap;html=0;align=right;points=[];verticalAlign=middle;labelBackgroundColor=#ffffff', 40, 100, 'Label', 'Vertical Dimension', null, null, 'vertical dimension measure'),

        this.addEntry('list', function()
        {
            var cell = new mxCell('List', new mxGeometry(0, 0, 140, 110),
                'swimlane;html=0;fontStyle=0;childLayout=stackLayout;horizontal=1;startSize=26;fillColor=none;horizontalStack=0;resizeParent=1;resizeLast=0;collapsible=1;marginBottom=0;swimlaneFillColor=#ffffff;');
            cell.vertex = true;
        ...
        this.addEntry(dt + 'object instance', function()
        {
            var cell = new mxCell('Classname', new mxGeometry(0, 0, 160, 90),
                'swimlane;html=0;fontStyle=1;align=center;verticalAlign=top;childLayout=stackLayout;horizontal=1;startSize=26;horizontalStack=0;resizeParent=1;resizeLast=0;collapsible=1;marginBottom=0;swimlaneFillColor=#ffffff;');
            cell.vertex = true;
        ...
        this.addEntry(dt + 'item member method function variable field attribute label', function()
        {
            var cell = new mxCell('item: attribute', new mxGeometry(0, 0, 120, field.geometry.height), 'label;html=0;fontStyle=0;strokeColor=none;fillColor=none;align=left;verticalAlign=top;overflow=hidden;' +
        ...
        {
            var cell = new mxCell('', new mxGeometry(0, 0, 20, 14), 'text;html=0;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingTop=-1;spacingLeft=4;spacingRight=4;rotatable=0;labelPosition=right;points=[];portConstraint=eastwest;');
            cell.vertex = true;

            return sb.createVertexTemplateFromCells([cell.clone()], cell.geometry.width, cell.geometry.height, 'Spacer');
        }),
        this.createVertexTemplateEntry('text;html=0;align=center;fontStyle=1;verticalAlign=middle;spacingLeft=3;spacingRight=3;strokeColor=none;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;',
            80, 26, 'Title', 'Title', null, null, dt + 'title label'),
        this.addEntry(dt + 'component', function()
        {
            var cell = new mxCell('&laquo;Annotation&raquo;<br/><b>Component</b>', new mxGeometry(0, 0, 180, 90), 'html=0;');
            cell.vertex = true;
        ...
        this.addEntry(dt + 'component', function()
        {
            var cell = new mxCell('<p style="margin:0px;margin-top:6px;text-align:center;"><b>Component</b></p>' +
                ...
                'align=left;overflow=fill;html=0;');
            cell.vertex = true;
        ...
        this.createVertexTemplateEntry('shape=lollipop;direction=south;html=0;', 30, 10, '', 'Provided Interface', null, null, dt + 'provided interface'),
        this.createVertexTemplateEntry('shape=requires;direction=north;html=0;', 30, 20, '', 'Required Interface', null, null, dt + 'required interface'),
        this.createVertexTemplateEntry('shape=umlBoundary;whiteSpace=wrap;html=0;', 100, 80, 'Boundary Object', 'Boundary Object', null, null, 'uml boundary object'),
        this.createVertexTemplateEntry('ellipse;shape=umlEntity;whiteSpace=wrap;html=0;', 80, 80, 'Entity Object', 'Entity Object', null, null, 'uml entity object'),
        this.createVertexTemplateEntry('ellipse;shape=umlControl;whiteSpace=wrap;html=0;', 70, 80, 'Control Object', 'Control Object', null, null, 'uml control object'),
        this.createVertexTemplateEntry('shape=umlActor;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;html=0;', 30, 60, 'Actor', 'Actor', false, null, 'uml actor'),
        this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=0;', 140, 70, 'Use Case', 'Use Case', null, null, 'uml use case usecase'),
        ...
        this.addEntry('uml activity state', function()
        {
            var cell = new mxCell('Activity', new mxGeometry(0, 0, 120, 40),
                'rounded=1;whiteSpace=wrap;html=0;arcSize=40;fillColor=#ffffc0;strokeColor=#ff0000;');
            cell.vertex = true;
        ...
        this.addEntry('uml activity composite state', function()
        {
            var cell = new mxCell('Composite State', new mxGeometry(0, 0, 160, 60),
                'swimlane;html=0;fontStyle=1;align=center;verticalAlign=middle;childLayout=stackLayout;horizontal=1;startSize=30;horizontalStack=0;resizeParent=0;resizeLast=1;container=0;collapsible=0;rounded=1;arcSize=30;strokeColor=#ff0000;fillColor=#ffffc0;swimlaneFillColor=#ffffc0;');
            cell.vertex = true;

            var cell1 = new mxCell('Subtitle', new mxGeometry(0, 0, 200, 26), 'text;html=0;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;spacingLeft=4;spacingRight=4;whiteSpace=wrap;overflow=hidden;rotatable=0;');
            cell1.vertex = true;
            cell.insert(cell1);
        ...
        {
            var cell = new mxCell('Condition', new mxGeometry(0, 0, 80, 40), 'rhombus;whiteSpace=wrap;html=0;fillColor=#ffffc0;strokeColor=#ff0000;');
            cell.vertex = true;
        ...
        this.createVertexTemplateEntry('shape=umlLifeline;perimeter=lifelinePerimeter;whiteSpace=wrap;html=0;container=1;collapsible=0;recursiveResize=0;outlineConnect=0;', 100, 300, ':Object', 'Lifeline', null, null, 'uml sequence participant lifeline'),
        this.createVertexTemplateEntry('shape=umlLifeline;participant=umlActor;perimeter=lifelinePerimeter;whiteSpace=wrap;html=0;container=1;collapsible=0;recursiveResize=0;verticalAlign=top;spacingTop=36;labelBackgroundColor=#ffffff;outlineConnect=0;',
            20, 300, '', 'Actor Lifeline', null, null, 'uml sequence participant lifeline actor'),
        this.createVertexTemplateEntry('shape=umlLifeline;participant=umlBoundary;perimeter=lifelinePerimeter;whiteSpace=wrap;html=0;container=1;collapsible=0;recursiveResize=0;verticalAlign=top;spacingTop=36;labelBackgroundColor=#ffffff;outlineConnect=0;',
            50, 300, '', 'Boundary Lifeline', null, null, 'uml sequence participant lifeline boundary'),
        this.createVertexTemplateEntry('shape=umlLifeline;participant=umlEntity;perimeter=lifelinePerimeter;whiteSpace=wrap;html=0;container=1;collapsible=0;recursiveResize=0;verticalAlign=top;spacingTop=36;labelBackgroundColor=#ffffff;outlineConnect=0;',
            40, 300, '', 'Entity Lifeline', null, null, 'uml sequence participant lifeline entity'),
        this.createVertexTemplateEntry('shape=umlLifeline;participant=umlControl;perimeter=lifelinePerimeter;whiteSpace=wrap;html=0;container=1;collapsible=0;recursiveResize=0;verticalAlign=top;spacingTop=36;labelBackgroundColor=#ffffff;outlineConnect=0;',
            40, 300, '', 'Control Lifeline', null, null, 'uml sequence participant lifeline control'),
        this.createVertexTemplateEntry('shape=umlFrame;whiteSpace=wrap;html=0;', 300, 200, 'frame', 'Frame', null, null, 'uml sequence frame'),
        this.createVertexTemplateEntry('shape=umlDestroy;whiteSpace=wrap;html=0;strokeWidth=3;', 30, 30, '', 'Destruction', null, null, 'uml sequence destruction destroy'),
        this.createVertexTemplateEntry('shape=note;whiteSpace=wrap;html=0;size=14;verticalAlign=top;align=left;spacingTop=-6;', 100, 70, 'Note', 'Note', null, null, 'uml note'),
        ...
        {
            var cell = new mxCell('', new mxGeometry(0, 0, 10, 60), 'html=0;points=[];perimeter=orthogonalPerimeter;');
            cell.vertex = true;

            var edge1 = new mxCell('callback', new mxGeometry(0, 0, 0, 0), 'html=0;verticalAlign=bottom;endArrow=block;entryX=1;entryY=0;');
            edge1.geometry.setTerminalPoint(new mxPoint(70, 0), true);
            edge1.geometry.relative = true;
            edge1.edge = true;
            ...
            var edge2 = new mxCell('return', new mxGeometry(0, 0, 0, 0), 'html=0;verticalAlign=bottom;endArrow=open;dashed=1;endSize=8;exitX=1;exitY=0.95;');
        ...
        this.addEntry('uml relation', function()
        {
            ...
            var cell = new mxCell('1', new mxGeometry(-1, 0, 0, 0), 'resizable=0;html=0;align=left;verticalAlign=bottom;labelBackgroundColor=#ffffff;fontSize=10;');
            cell.geometry.relative = true;
        ...
        this.addEntry('uml association', function()
        {
            ...
            var cell1 = new mxCell('parent', new mxGeometry(-1, 0, 0, 0), 'resizable=0;html=0;align=left;verticalAlign=bottom;labelBackgroundColor=#ffffff;fontSize=10;');
            cell1.geometry.relative = true;
            cell1.setConnectable(false);
            cell1.vertex = true;
            edge.insert(cell1);

            var cell2 = new mxCell('child', new mxGeometry(1, 0, 0, 0), 'resizable=0;html=0;align=right;verticalAlign=bottom;labelBackgroundColor=#ffffff;fontSize=10;');
        ...
        this.addEntry('uml relation', function()
        {
            ...
            var cell1 = new mxCell('0..n', new mxGeometry(-1, 0, 0, 0), 'resizable=0;html=0;align=left;verticalAlign=top;labelBackgroundColor=#ffffff;fontSize=10;');
            cell1.geometry.relative = true;
            cell1.setConnectable(false);
            cell1.vertex = true;
            edge.insert(cell1);

            var cell2 = new mxCell('1', new mxGeometry(1, 0, 0, 0), 'resizable=0;html=0;align=right;verticalAlign=top;labelBackgroundColor=#ffffff;fontSize=10;');
            cell2.geometry.relative = true;
            cell2.setConnectable(false);
            cell2.vertex = true;
            edge.insert(cell2);
        ...
        this.createEdgeTemplateEntry('endArrow=open;startArrow=circlePlus;endFill=0;startFill=0;endSize=8;html=0;', 160, 0, '', 'Inner Class', null, 'inner class'),
        this.createEdgeTemplateEntry('endArrow=open;startArrow=cross;endFill=0;startFill=0;endSize=8;startSize=10;html=0;', 160, 0, '', 'Terminate', null, 'terminate'),
        this.createVertexTemplateEntry('shape=ext;rounded=1;html=0;whiteSpace=wrap;', 120, 80, 'Task', 'Process', null, null, 'bpmn task process'),
        this.createVertexTemplateEntry('shape=ext;rounded=1;html=0;whiteSpace=wrap;double=1;', 120, 80, 'Transaction', 'Transaction', null, null, 'bpmn transaction'),
        this.createVertexTemplateEntry('shape=ext;rounded=1;html=0;whiteSpace=wrap;dashed=1;dashPattern=1 4;', 120, 80, 'Event\nSub-Process', 'Event Sub-Process', null, null, 'bpmn event subprocess sub process sub-process'),
        this.createVertexTemplateEntry('shape=ext;rounded=1;html=0;whiteSpace=wrap;strokeWidth=3;', 120, 80, 'Call Activity', 'Call Activity', null, null, 'bpmn call activity'),
        this.addEntry('bpmn subprocess sub process sub-process', function()
        {
            var cell = new mxCell('Sub-Process', new mxGeometry(0, 0, 120, 80), 'html=0;whiteSpace=wrap;rounded=1;');
            cell.vertex = true;
        ...
        {
            var cell = new mxCell('Looped\nSub-Process', new mxGeometry(0, 0, 120, 80), 'html=0;whiteSpace=wrap;rounded=1');
            cell.vertex = true;

            var cell1 = new mxCell('', new mxGeometry(0.5, 1, 14, 14), 'html=0;shape=mxgraph.bpmn.loop;');
            cell1.vertex = true;
            cell1.geometry.relative = true;
        ...
        {
            var cell = new mxCell('Receive', new mxGeometry(0, 0, 120, 80), 'html=0;whiteSpace=wrap;rounded=1;');
            cell.vertex = true;

            var cell1 = new mxCell('', new mxGeometry(0, 0, 20, 14), 'html=0;shape=message;');
            cell1.vertex = true;
            cell1.geometry.relative = true;
        ...
        {
            var cell = new mxCell('User', new mxGeometry(0, 0, 120, 80), 'html=0;whiteSpace=wrap;rounded=1;');
            cell.vertex = true;

            var cell1 = new mxCell('', new mxGeometry(0, 0, 14, 14), 'html=0;shape=mxgraph.bpmn.user_task;');
            cell1.vertex = true;
            cell1.geometry.relative = true;
            cell1.geometry.offset = new mxPoint(7, 7);
            cell.insert(cell1);
        ...
        {
            var cell = new mxCell('Process', new mxGeometry(0, 0, 120, 80), 'html=0;whiteSpace=wrap;rounded=1;');
            cell.vertex = true;

            var cell1 = new mxCell('', new mxGeometry(1, 1, 30, 30), 'shape=mxgraph.bpmn.timer_start;perimeter=ellipsePerimeter;html=0;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;');
            cell1.vertex = true;
            cell1.geometry.relative = true;
        ...
        this.addEntry(this.getTagsForStencil('mxgraph.bpmn', 'timer_start', 'attached').join(' '), function()
        {
            ...
            var cell1 = new mxCell('', new mxGeometry(1, 0, 30, 30), 'shape=mxgraph.bpmn.timer_start;perimeter=ellipsePerimeter;html=0;labelPosition=right;labelBackgroundColor=#ffffff;align=left;');
            cell1.vertex = true;
            cell1.geometry.relative = true;
        ...
        this.createVertexTemplateEntry('swimlane;html=0;horizontal=0;swimlaneFillColor=white;swimlaneLine=0;', 300, 120, 'Lane', 'Lane', null, null, 'bpmn lane'),
        this.createVertexTemplateEntry('shape=hexagon;html=0;whiteSpace=wrap;perimeter=hexagonPerimeter;', 60, 50, '', 'Conversation', null, null, 'bpmn conversation'),
        this.createVertexTemplateEntry('shape=hexagon;html=0;whiteSpace=wrap;perimeter=hexagonPerimeter;strokeWidth=4', 60, 50, '', 'Call Conversation', null, null, 'bpmn call conversation'),
        this.addEntry('bpmn subconversation sub conversation sub-conversation', function()
        {
            var cell = new mxCell('', new mxGeometry(0, 0, 60, 50), 'shape=hexagon;whiteSpace=wrap;html=0;perimeter=hexagonPerimeter;');
            cell.vertex = true;
        ...
        {
            var cell = new mxCell('', new mxGeometry(0, 0, 40, 60), 'shape=note;whiteSpace=wrap;size=16;html=0;');
            cell.vertex = true;

            var cell1 = new mxCell('', new mxGeometry(0, 0, 14, 14), 'html=0;shape=singleArrow;arrowWidth=0.4;arrowSize=0.4;');
            cell1.vertex = true;
            cell1.geometry.relative = true;
            cell1.geometry.offset = new mxPoint(2, 2);
            cell.insert(cell1);

            var cell2 = new mxCell('', new mxGeometry(0.5, 1, 14, 14), 'html=0;whiteSpace=wrap;shape=parallelMarker;');
            cell2.vertex = true;
            cell2.geometry.relative = true;
            cell2.geometry.offset = new mxPoint(-7, -14);
            cell.insert(cell2);
        ...
        this.createVertexTemplateEntry('shape=datastore;whiteSpace=wrap;html=0;', 60, 60, '', 'Data Store', null, null, 'bpmn data store'),
        this.createVertexTemplateEntry('shape=plus;html=0;', 14, 14, '', 'Sub-Process Marker', null, null, 'bpmn subprocess sub process sub-process marker'),
        this.createVertexTemplateEntry('shape=mxgraph.bpmn.loop;html=0;', 14, 14, '', 'Loop Marker', null, null, 'bpmn loop marker'),
        this.createVertexTemplateEntry('shape=parallelMarker;html=0;', 14, 14, '', 'Parallel MI Marker', null, null, 'bpmn parallel mi marker'),
        this.createVertexTemplateEntry('shape=parallelMarker;direction=south;html=0;', 14, 14, '', 'Sequential MI Marker', null, null, 'bpmn sequential mi marker'),
        this.createVertexTemplateEntry('shape=mxgraph.bpmn.ad_hoc;fillColor=#000000;html=0;', 14, 14, '', 'Ad Hoc Marker', null, null, 'bpmn ad hoc marker'),
        this.createVertexTemplateEntry('shape=mxgraph.bpmn.compensation;html=0;', 14, 14, '', 'Compensation Marker', null, null, 'bpmn compensation marker'),
        this.createVertexTemplateEntry('shape=message;whiteSpace=wrap;html=0;fillColor=#000000;strokeColor=#ffffff;strokeWidth=2;', 40, 30, '', 'Send Task', null, null, 'bpmn send task'),
        this.createVertexTemplateEntry('shape=message;whiteSpace=wrap;html=0;', 40, 30, '', 'Receive Task', null, null, 'bpmn receive task'),
        this.createVertexTemplateEntry('shape=mxgraph.bpmn.user_task;html=0;', 14, 14, '', 'User Task', null, null, this.getTagsForStencil('mxgraph.bpmn', 'user_task').join(' ')),
        this.createVertexTemplateEntry('shape=mxgraph.bpmn.manual_task;html=0;', 14, 14, '', 'Manual Task', null, null, this.getTagsForStencil('mxgraph.bpmn', 'user_task').join(' ')),
        this.createVertexTemplateEntry('shape=mxgraph.bpmn.business_rule_task;html=0;', 14, 14, '', 'Business Rule Task', null, null, this.getTagsForStencil('mxgraph.bpmn', 'business_rule_task').join(' ')),
        this.createVertexTemplateEntry('shape=mxgraph.bpmn.service_task;html=0;', 14, 14, '', 'Service Task', null, null, this.getTagsForStencil('mxgraph.bpmn', 'service_task').join(' ')),
        this.createVertexTemplateEntry('shape=mxgraph.bpmn.script_task;html=0;', 14, 14, '', 'Script Task', null, null, this.getTagsForStencil('mxgraph.bpmn', 'script_task').join(' ')),
        ...
        this.addEntry('bpmn message flow', function()
        {
            ...
            var cell = new mxCell('', new mxGeometry(0, 0, 20, 14), 'shape=message;html=0;');
            cell.geometry.relative = true;
            cell.setConnectable(false);
            cell.vertex = true;
...
Sidebar.prototype.itemClicked = function(cells, ds, evt, elt)
{
	...
	{
		// al, make it the selected object, so that new inserts will use this shape
...
Sidebar.prototype.addImagePalette = function(id, title, prefix, postfix, items, titles, tags)
{
	...
	for (var i = 0; i < items.length; i++)
	{
		(mxUtils.bind(this, function(item, title, tmpTags)
		{
			...
			fns.push(this.createVertexTemplateEntry('image;html=0;labelBackgroundColor=#ffffff;image=' + prefix + item + postfix,
