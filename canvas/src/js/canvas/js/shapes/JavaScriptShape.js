// Javascript shape
function JavaScriptShape()
{
    mxRectangleShape.call(this);
};
mxUtils.extend(JavaScriptShape, mxRectangleShape);
JavaScriptShape.prototype.isHtmlAllowed = function()
{
    return false;
};
JavaScriptShape.prototype.getLabelBounds = function(rect)
{
...
JavaScriptShape.prototype.paintForeground = function(c, x, y, w, h)
{
    if (this.style != null)
    {
...
mxCellRenderer.prototype.defaultShapes['javascript'] = JavaScriptShape;